...
export const Dashboard: React.FC<DashboardProps> = ({ status, historyData }) => {
  ...
  // Visual scaling: Assume 0.20 is max for full visual height
  ...
  return (
    <div className="w-full h-full flex flex-col p-6 animate-fade-in relative overflow-hidden">
      ...
      {/* Header */}
      <div className="flex justify-between items-center mb-6 z-10 pt-2">
        <div>
      ...
      <div className="flex-1 flex flex-col items-center justify-center relative -mt-4">
        ...
        <div className="relative w-72 h-72 md:w-80 md:h-80 glass-sphere rounded-full overflow-hidden flex items-center justify-center transform transition-transform duration-500 hover:scale-[1.02]">
          ...
          <div className="relative z-20 text-center flex flex-col items-center drop-shadow-2xl">
            ...
            <span className="text-white/80 text-sm font-bold tracking-[0.2em] uppercase mt-2 backdrop-blur-sm px-3 py-1 rounded-full bg-black/20">
              BAC Level
            </span>
          </div>
        </div>
        ...
        <div className="grid grid-cols-2 gap-4 w-full max-w-xs mt-10">
           <div className="glass-panel-3d p-4 rounded-[24px] flex flex-col items-center justify-center group hover:bg-white/5 transition-colors">
              ...
              <div className="text-[10px] text-blue-200/60 uppercase tracking-wider font-semibold">Sober At</div>
           </div>
           <div className="glass-panel-3d p-4 rounded-[24px] flex flex-col items-center justify-center group hover:bg-white/5 transition-colors">
              ...
              <div className="text-[10px] text-pink-200/60 uppercase tracking-wider font-semibold">Limit Load</div>
           </div>
        </div>
      </div>
